...
export const GOOGLE_REGISTER_REDIRECT_URI = import.meta.env.VITE_GOOGLE_REGISTER_REDIRECT_URI;
...
export const KAKAO_REGISTER_REDIRECT_URI = import.meta.env.VITE_KAKAO_REGISTER_REDIRECT_URI;
