...
const PaymentInfo = ({ resType, form }) => {
  ...
  const paymentProcessValidate = useReservationStore(
    (s) => s.paymentProcessValidate
  );
        ...
        <div className="pay_right">
          ...
          <div className="pay_agree">
            <div className="pay_agree_inner">
              <div className={`check__line ${payAgree ? "inputCheck" : ""}`}>
                <input
                  id="chkAgree"
                  type="checkbox"
                  checked={payAgree}
              ...
              <div className="text_area">
                ...
                <p>
                  결제 완료 시 아래 내용을 확인하고 동의한 것으로 간주됩니다.
                </p>
                {/* <br />
                                <p>
