        ...
        <div className="check_area">
          ...
          <div className="notification">
            <div className="context">
              <span>
                1. 모든 미용 서비스는 예약제로 운영되며, 예약 변경 및 취소는
                최소 하루 전까지 가능합니다.
              </span>
              <br />
              <span>
                2. 접종이 완료되지 않았거나, 최근 아픈 이력 또는 피부 질환이
                있는 반려견은 반드시 사전 고지해 주세요.
              </span>
              <br />
              <span>
                3. 반려견이 긴장하지 않도록 평소 즐겨 먹는 간식을 지참해 주시면
                미용 시 보상으로 활용됩니다.
              </span>
              <br />
              <span>
                4. 호텔링과 함께 미용을 진행하는 경우, 낯선 환경에서도 편하게
                식사할 수 있도록 사료를 지참해 주세요.
              </span>
              <br />
